            ...
            <div className="row">
              ...
              <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                <div className="tp-footer-widget footer-col-2 mb-50">
                  <h4 className="tp-footer-widget-title">About</h4>
                  <div className="tp-footer-widget-content">
                    <ul>
                      <li>
                ...
                <div className="tp-footer-widget footer-col-3 mb-50">
                  ...
                  <div className="tp-footer-widget-content">
                    <ul>
                      ...
                      <li>
                        <Link href="/return-policy" legacyBehavior>
                ...
                <div className="tp-footer-widget footer-col-4 mb-50">
                  ...
                  <div className="tp-footer-widget-content">
                    <div className="tp-footer-talk mb-20">
                      ...
                      <h4><a href="tel:670-413-90-762">+91 9973103394</a></h4>
                    </div>
                    <div className="tp-footer-contact">
                      <div className="tp-footer-contact-item d-flex align-items-start">
                        ...
                        <div className="tp-footer-contact-content">
                          <p><a href="mailto:goldsmithdeepakkumar@gmail.com">goldsmithdeepakkumar@gmail.com</a></p>
                        </div>
                      </div>
                      <div className="tp-footer-contact-item d-flex align-items-start">
                        <div className="tp-footer-contact-icon">
                        ...
                        <div className="tp-footer-contact-content">
                          <p><a href="https://www.google.com/maps/place/Manokamana+Alankar+Jewellers/@26.0589859,85.5084826,17z/data=!3m1!4b1!4m6!3m5!1s0x39ed0dc46ae2243b:0xab5ca5841cd522d8!8m2!3d26.0589859!4d85.5084826!16s%2Fg%2F11cs17hg7k?entry=ttu&g_ep=EgoyMDI1MDkxNy4wIKXMDSoASAFQAw%3D%3D" target="_blank">Dardha Bazaar Baikatpur Haat,<br />Baikunthpur, Bihar 843132</a></p>
                        </div>
                      </div>
                    </div>
                  </div>
